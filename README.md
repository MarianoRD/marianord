...
expensive — sensitive data, compliance, audit trails, customers who happen
to be Apple, Google, Meta, Oracle, and Fortune 100 banks.

Originally from Venezuela, based in Mexico, with a regional Latin American
perspective on cloud — operating infrastructure across countries shapes
...
* 🛡 **Platform engineering in regulated environments** — SOC 2, ISO 27001,
  audit trails, PII at scale.
...
* Leading the platform team at [Covalynt](https://covalynt.com).
...
See my [Sessionize profile](https://sessionize.com/marianord/) for recent talks.
Recent writing on [marianord.com](https://marianord.com).

---

<sub>If your infra is exciting, something is wrong.</sub>